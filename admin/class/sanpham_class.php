...
class sanpham {
    ...
    public function insert_sanpham() {
        ...
        $query = "INSERT INTO sanpham (ten_sanpham, ten_danhmuc, giasp, mota, anh) 
                  VALUES ('$ten_sanpham', '$ten_danhmuc', '$giasp', '$mota', '$anh')";
    ...
    public function update_sanpham($ten_sanpham, $id_sanpham, $ten_danhmuc, $giasp, $mota, $anh) {
